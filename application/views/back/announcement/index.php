                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $bras  = $panel_user['user_ep'];
                     $d = datalist('lessons',array('lesson_cat' => $bras , 'status' => '1'));
                     foreach ($d as $d) { 
                    $a = datalist('announcement',array(''),'creat_time', 'ASC');
                     foreach ($a as $a) {
                      if ($a['ann_view_dep'] == $d['id'] and '01' && $a['status'] == 1 ) {
                  ...
                  <tr>
                    ...
                    <td><?= $a['creat_time'];?></td>
                     ...
                     <?php  
                    if ($a['admin'] != 1) {                       
                     $f = datalist('user',array('user_bra' => $a['ann_view_dep'] ));
                      foreach ($f as $f) {;?>
