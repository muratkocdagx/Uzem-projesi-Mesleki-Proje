              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane active" id="bolumkayit">
                    <form class="form-horizontal" action="<?= base_url('lessons/inserting');?>" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputName" placeholder="" name="credit">
                        </div>
                      </div>
                       <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Ders Akts</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputName" placeholder="" name="akts">
                        </div>
                      </div>
                      <div class="form-group row">
