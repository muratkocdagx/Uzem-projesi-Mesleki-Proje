...
<?php $this->load->view('back/back_module/public/page_fix/sidebar.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="container-fluid">
      <a href="<?php echo base_url('lessons/insert') ?>"><button type="button" class="btn btn-success pull-right" name="button"><i class="fa fa-plus" style="margin-right: 5px;"></i>ekle</button></a><br><br>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?= $list['lesson_code'];?></td>
                    <td><?= $list['lesson_credit'];?></td>
                    <td><?= $list['lesson_akts'];?></td>
                    ...
                    dataURL="<?php echo base_url('back/lessons/Home/set') ?>"
                    <?php echo ($list['status'] == 1) ? "checked" : "";
                    ?>
                    >

                    </td>
                     <?php  $folcek = datalist('department',array('id' => $list['lesson_cat']));
                         foreach ($folcek as $f) {;?>
                      <td><?= $f['department_name'];?></td>
                    <?php } ?>
                    <td>
                      <a href="<?php echo base_url('lessons/edit/'.$list['id'].''); ?>"><button type="button" class="btn btn-info" name="button">Düzenle</button></a>
                  <a href="<?php echo base_url('lessons/delete/'.$list['id'].''); ?>"><button type="button" class="btn btn-danger" name="button">Sil</button></a>
                    </td>
                  </tr>
