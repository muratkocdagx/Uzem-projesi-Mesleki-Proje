              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane active" id="bolumkayit">
                    <form class="form-horizontal" action="<?= base_url('department/editing');?>" method="post" enctype="multipart/form-data">
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Bölüm Adı</label>
                        <div class="col-sm-10">
                          <input type="hidden" name="id" value="<?= $list['id'] ?>">
                          <input type="text" class="form-control" id="inputName" value="<?= $list['department_name'] ?>" name="name">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Bölüm Numarası</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="inputName" value="<?= $list['rank'] ?>" name="code">
                        </div>
                      </div>
                      <div class="form-group row">
