...
<?php $this->load->view('back/back_module/public/page_fix/sidebar.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="container-fluid">
      <a href="<?php echo base_url('add-announcement/insert') ?>"><button type="button" class="btn btn-success pull-right" name="button"><i class="fa fa-plus" style="margin-right: 5px;"></i>ekle</button></a><br><br>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    dataURL="<?php echo base_url('back/add-announcement/Home/set') ?>"
                    ...
                    <td>
                      <a href="<?php echo base_url('add-announcement/edit/'.$list['id'].''); ?>"><button type="button" class="btn btn-info" name="button">Düzenle</button></a>
                  <a href="<?php echo base_url('add-announcement/delete/'.$list['id'].''); ?>"><button type="button" class="btn btn-danger" name="button">Sil</button></a>
                    </td>
                  </tr>
